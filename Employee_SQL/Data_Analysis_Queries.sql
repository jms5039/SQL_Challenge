...
-- Display output that says "The manager of {department name} (department number) is {full name} (manager employee number)" for each department
SELECT
...
-- Generate output that says "The department number for {employee full name} (employee number) is {department name}" for each employee
SELECT
...
-- Display saying "Employees in the Sales Department: " and list the full names and employee numbers in parentheses for everyone in this department
SELECT
